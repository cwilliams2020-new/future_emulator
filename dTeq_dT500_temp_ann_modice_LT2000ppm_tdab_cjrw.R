...
cont_paramdat = read.table(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Input/Samp_orbits_tdum.res'), sep=" ", header=TRUE)
...
for (i in Exp_list_LC_tdum) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Output/dTeq/LT2000/', paste("dTeq_temp_mm_1_5m_ann_", Exp, ".nc", sep="")))
...
source("C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/R/Emulator_remove_vars2.R")
...
cont_paramdat = read.table(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Input/Samp_orbits_tdvo_LT2000ppm.res'), sep=" ", header=TRUE)
...
for (i in Exp_list_LC_tdvo) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Output/dTeq/LT2000/', paste("dTeq_temp_mm_1_5m_ann_", Exp, "_LT2000ppm.nc", sep="")))
	lats_dat = ncvar_get(nc, "latitude")
	lons_dat = ncvar_get(nc, "longitude")
...
cont_paramdat = read.table(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Input/Singarayer + Valdes 2010/Samp_orbits_tdab.res'), sep=" ", header=TRUE)
...
for (i in Exp_list_LC_tdab) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Output/Singarayer + Valdes 2010/', paste("dT500_temp_mm_1_5m_ann_", Exp, "28k.nc", sep="")))
	lats_dat = ncvar_get(nc, "latitude")
	lons_dat = ncvar_get(nc, "longitude")
	
	var_nam=paste(Exp, i, sep = "")
	temp = ncvar_get(nc, var_nam)
	nam = paste("temp_tdab", i, "_kdat", sep = "")
	assign(nam, temp)
	nc_close(nc)
	rm(nc, temp)
}
...
for (i in Exp_list_UC_tdab) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Output/Singarayer + Valdes 2010/', paste("dT500_temp_mm_1_5m_ann_", Exp, "80k.nc", sep="")))
	lats_dat = ncvar_get(nc, "latitude")
	lons_dat = ncvar_get(nc, "longitude")
...
for (i in Exp_list_NUM_tdab) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Output/Singarayer + Valdes 2010/', paste("dT500_temp_mm_1_5m_ann_", Exp, "120k.nc", sep="")))
	lats_dat = ncvar_get(nc, "latitude")
	lons_dat = ncvar_get(nc, "longitude")
...
temp_tdab_k_all = matrix(0, nrow = length(temp_tdabc_kdat), ncol = Exp_num_tdab)
j = 1


for (i in Exp_list_LC_tdab) {
  nam = paste("temp_tdab", i, "_kdat", sep = "")
  nam_new = paste("temp_tdab", i, "_k_vec", sep = "")
  data = matrix(data=eval(parse(text=nam)), ncol = 73)
  data_new = as.vector(data)
  assign(nam_new, data_new)
  temp_tdab_k_all[,j] = data_new
  rm(data)
  j = j + 1
}
...
model_output_tdab = temp_tdab_k_all
