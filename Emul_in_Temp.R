...
# load HadCM3 data from several experiment families
source('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/Data/Data - dTeq dT500/dTeq_dT500_temp_ann_modice_LT2000ppm_tdab_cjrw.R') # tdum, tdvo and tdab
source('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/Data/Data - dTeq dT500/dTeq_dT500_temp_ann_modlowice_LT2000ppm_cjrw.R')

# Clear some unnecessary variables, except those listed here
source("C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/R/Emulator_remove_vars1.R")

# Load PI control
source('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/Data/Data - Climate NC/Tdst_temp_mm_1_5m_cjrw.R')
K = 273.15
model_output_tdst = model_output_tdst - K # Convert SAT to Deg C


# Calculate anomaly compared to PI for tdab (S+V data)
# (Other experiments are already in the form of anomaly from pre-industrial)
model_output_modice_tdab_orig = model_output_modice_tdab
tdab_exps = seq(Exp_num_tdum+Exp_num_tdvo+1,Exp_num_tdum+Exp_num_tdvo+Exp_num_tdab) # Go through only the tdab simulations in the merged output array
for(i in tdab_exps){
    model_output_modice_tdab[,,i] = model_output_modice_tdab_orig[,,i] - model_output_modice_tdab_orig[,,tdab_exps[1]] # The first entry in model_output_modice_tdab is the absolute pre-industrial value
}
...
source('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/R/pca_emul.R')

par_orig=par() # Don't know if this does anything...
