...
cont_paramdat = read.table(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Input/Samp_orbits_tdst.res'), sep=" ", header=TRUE)
...
for (i in Exp_list) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Output/Climate NC/', paste( Exp, i, "a.pdclann.nc", sep="")))
