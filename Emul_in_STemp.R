...
## Calibrate final using soiltemp_mm_soil #########################################################
###################################################################################################
...
# load data
source('../Data/Data - dTeq dT500/dTeq_dT500_soiltemp_l1_ann_modice_LT2000ppm_tdab.R')
source('../Data/Data - dTeq dT500/dTeq_dT500_soiltemp_l1_ann_modlowice_LT2000ppm.R')

print('Emulator_soiltemp')

# Clear some unnecessary variables, except those listed here
source("Emulator_remove_vars1.R")

source('../Data/Data - Climate NC/Tdst_soiltemp_mm_soil.R')
...
for(i in tdab_exps){
  model_output_modice_tdab[,,i] = model_output_modice_tdab[,,i] - K
}
