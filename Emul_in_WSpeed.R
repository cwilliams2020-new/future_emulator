...
## Calibrate final using windspeed_mm_10m #############################################################
###################################################################################################
...
# load data
source('../Data/Data - dTeq dT500/dTeq_dT500_windspeed_ann_modice_LT2000ppm_tdab.R')
source('../Data/Data - dTeq dT500/dTeq_dT500_windspeed_ann_modlowice_LT2000ppm.R')

print('Emulator_windspeed')

# Clear some unnecessary variables, except those listed here
source("Emulator_remove_vars1.R")

source('../Data/Data - Climate NC/Tdst_windspeed_mm_10m.R')
