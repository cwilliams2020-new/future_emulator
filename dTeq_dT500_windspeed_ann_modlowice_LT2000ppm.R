...
model_output_tdvp <- array(model_output_tdvp, c(96, 72, Exp_num_tdvp ))
...
model_output_tdvq <- array(model_output_tdvq, c(96, 72, Exp_num_tdvq ))
...
model_output_modlowice <- array(0, c(96, 72, (Exp_num_tdum+Exp_num_tdvo+Exp_num_tdvp+Exp_num_tdvq)))
