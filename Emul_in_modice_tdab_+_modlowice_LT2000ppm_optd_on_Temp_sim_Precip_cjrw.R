...
## Calibrate final using precip_mm_srf ############################################################
###################################################################################################
...
# load data
source('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/Data/Data - dTeq dT500/dTeq_dT500_precip_ann_modice_LT2000ppm_tdab_cjrw.R')
source('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/Data/Data - dTeq dT500/dTeq_dT500_precip_ann_modlowice_LT2000ppm_cjrw.R')
...
# Convert from mm per sec to mm per day (same as kg m-2) (tdab only)

model_output_modice_tdab[,,(Exp_num_tdum+Exp_num_tdvo+1):(Exp_num_tdum+Exp_num_tdvo+Exp_num_tdab)]=model_output_modice_tdab[,,(Exp_num_tdum+Exp_num_tdvo+1):(Exp_num_tdum+Exp_num_tdvo+Exp_num_tdab)]*60*60*24
