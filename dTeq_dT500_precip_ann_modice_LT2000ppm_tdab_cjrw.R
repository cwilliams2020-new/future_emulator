...
cont_paramdat = read.table(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/orig/Input/Samp_orbits_tdum.res'), sep=" ", header=TRUE)
...
for (i in Exp_list_LC_tdum) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/orig/Output/dTeq/LT2000/', paste("dTeq_precip_mm_srf_ann_", Exp, ".nc", sep="")))
...
source("C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/R/Emulator_remove_vars2.R")
...
cont_paramdat = read.table(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/orig/Input/Samp_orbits_tdvo_LT2000ppm.res'), sep=" ", header=TRUE)
...
for (i in Exp_list_LC_tdvo) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/orig/Output/dTeq/LT2000/', paste("dTeq_precip_mm_srf_ann_", Exp, "_LT2000ppm.nc", sep="")))
	lats_dat = ncvar_get(nc, "latitude")
	lons_dat = ncvar_get(nc, "longitude")
...
cont_paramdat = read.table(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/orig/Input/Singarayer + Valdes 2010/Samp_orbits_tdab.res'), sep=" ", header=TRUE)
...
for (i in Exp_list_LC_tdab) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/orig/Output/Singarayer + Valdes 2010/', paste("dT500_precip_mm_srf_ann_", Exp, "28k.nc", sep="")))
	lats_dat = ncvar_get(nc, "latitude")
	lons_dat = ncvar_get(nc, "longitude")
...
for (i in Exp_list_UC_tdab) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/orig/Output/Singarayer + Valdes 2010/', paste("dT500_precip_mm_srf_ann_", Exp, "80k.nc", sep="")))
	lats_dat = ncvar_get(nc, "latitude")
	lons_dat = ncvar_get(nc, "longitude")
...
for (i in Exp_list_NUM_tdab) {
	nc = nc_open(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/SKB/SKB_Alan_Code_DJL/PosivaSKB/PosivaSKB/Emulator/2015_Bristol_5D_v001/orig/Output/Singarayer + Valdes 2010/', paste("dT500_precip_mm_srf_ann_", Exp, "120k.nc", sep="")))
	lats_dat = ncvar_get(nc, "latitude")
	lons_dat = ncvar_get(nc, "longitude")
