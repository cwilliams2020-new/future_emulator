...
source('../Data/Data - dTeq dT500/dTeq_dT500_precip_ann_modice_LT2000ppm_tdab.R')
source('../Data/Data - dTeq dT500/dTeq_dT500_precip_ann_modlowice_LT2000ppm.R')

print('Emulator_Precip')

# Clear some unnecessary variables, except those listed here
source("Emulator_remove_vars1.R")

# Load PI control
source('../Data/Data - Climate NC/Tdst_precip_mm_srf.R')
