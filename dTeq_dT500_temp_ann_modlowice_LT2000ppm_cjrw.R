...
cont_paramdat = read.table(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Input/Samp_orbits_tdvp.res'), sep=" ", header=TRUE)
...
cont_paramdat = read.table(file.path('C:/Users/cw18831/OneDrive - University of Bristol/Documents/Research/KAERI/Emulator code/Emulator/2015_Bristol_5D_v001/orig/Input/Samp_orbits_tdvq_LT2000ppm.res'), sep=" ", header=TRUE)
