...
## Calibrate final using sm_mm_soil ###############################################################
###################################################################################################
...
# load data
source('../Data/Data - dTeq dT500/dTeq_dT500_sm_l1_ann_modice_LT2000ppm_tdab.R')
source('../Data/Data - dTeq dT500/dTeq_dT500_sm_l1_ann_modlowice_LT2000ppm.R')

print('Emulator_soilmoisture')

# Clear some unnecessary variables, except those listed here
source("Emulator_remove_vars1.R")

source('../Data/Data - Climate NC/Tdst_sm_mm_soil.R')
